...
async def save_image_to_file(image, file_path):
...
async def send_image_to_ollama(base64_image):
    ...
    try:
        ...
        response = await AsyncClient().chat(
            model="llava", messages=[message]  # Specify the desired LLaVA model size
        )
    ...
    while True:
        ...
        try:
            ...
            if (
                ...
                await send_image_to_ollama(base64_image)
